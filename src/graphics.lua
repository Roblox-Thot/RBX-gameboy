...
local Cache = gbloadfile('gayboy/graphics/cache.lua')()
local Palette = gbloadfile('gayboy/graphics/palette.lua')()
local Registers = gbloadfile('gayboy/graphics/registers.lua')()
